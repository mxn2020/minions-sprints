# Manual Setup Steps for Minions Sprints
...
Go to **GitHub → mxn2020/minions-sprints → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-sprints` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-sprints-web`
- **GitHub repo**: `mxn2020/minions-sprints`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `sprints.minions.wtf`

### Documentation
- **Netlify site name**: `minions-sprints-docs`
- **GitHub repo**: `mxn2020/minions-sprints`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `sprints.minions.help`

### Blog
- **Netlify site name**: `minions-sprints-blog`
- **GitHub repo**: `mxn2020/minions-sprints`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `sprints.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `sprints.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `sprints.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `sprints.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-sprints/sdk`](https://www.npmjs.com/package/@minions-sprints/sdk)
- CLI: [`@minions-sprints/cli`](https://www.npmjs.com/package/@minions-sprints/cli)
...
Your package: [`minions-sprints`](https://pypi.org/project/minions-sprints/)
...
| Item | Value |
|------|-------|
| Project | `minions-sprints` |
| SDK (npm) | `@minions-sprints/sdk` |
| CLI (npm) | `@minions-sprints/cli` |
| Python (PyPI) | `minions-sprints` |
| GitHub | `github.com/mxn2020/minions-sprints` |
| Docs domain | `sprints.minions.help` |
| Blog domain | `sprints.minions.blog` |
| App domain | `sprints.minions.wtf` |
