...
/**
 * @minions-sprints/cli — CLI for Minions Sprints
 *
...
import { customTypes } from '@minions-sprints/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Sprints'));
        console.log(chalk.dim('Sprint definitions, scope, and velocity tracking'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-sprints/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-sprints/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-sprints')}`);
